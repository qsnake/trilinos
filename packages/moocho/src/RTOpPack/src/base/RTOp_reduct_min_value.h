...
#ifndef RTOP_REDUCT_MIN_VALUE_H
#define RTOP_REDUCT_MIN_VALUE_H
...
/** @name Definitions of reduction functions for min(.,.) scalar values.
 *
 * These functions perform a simple <tt>min()</tt> of a scalar reduction objects
