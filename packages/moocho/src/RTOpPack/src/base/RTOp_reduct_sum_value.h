...
#ifndef RTOP_REDUCT_SUM_VALUE_H
#define RTOP_REDUCT_SUM_VALUE_H
...
/** @name Definitions of reduction functions for summing scalar value.
 *
 * These functions perform a simple sum of a scalar reduction object
