...
namespace TSFExtended
{
   ...
   * 
   * Default implementations of the loadable and accessible interface
   * methods are provided. 
   * 
   * @author Kevin Long (krlong@sandia.gov)
   */
  template <class Scalar>
  class IndexableVector : public virtual LoadableVector<Scalar>,
                          public virtual AccessibleVector<Scalar>
    {
    public:
      /** virtual dtor */
