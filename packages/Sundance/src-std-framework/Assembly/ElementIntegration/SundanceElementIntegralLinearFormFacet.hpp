...
#ifndef SUNDANCE_ELEMENTINTEGRALLINEARFORMFACET_H
#define SUNDANCE_ELEMENTINTEGRALLINEARFORMFACET_H
...
namespace SundanceStdFwk
{
  ...
  namespace Internal
  {
    ...
    /** 
     * ElementIntegralLinearFormFacet provides an abstract base class for
     streaming functional evaluation over a batch of facets of cells.
     It provides a single pure virtual function for subclasses
     to implement.
    */
    class ElementIntegralLinearFormFacet : public ElementIntegralLinearForm
    {
    public:
      /** Constructor */
      ElementIntegralLinearFormFacet( int spatialDim,
	...
	ElementIntegralLinearForm( spatialDim , maxCellType ,
      ...
      /** Destructor */
      virtual ~ElementIntegralLinearFormFacet() {;}
