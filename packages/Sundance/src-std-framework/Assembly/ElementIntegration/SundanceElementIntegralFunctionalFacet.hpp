...
#ifndef SUNDANCE_ELEMENTINTEGRALFUNCTIONALFACET_H
#define SUNDANCE_ELEMENTINTEGRALFUNCTIONALFACET_H
...
namespace SundanceStdFwk
{
  ...
  namespace Internal
  {
     ...
     * ElementIntegralFunctional provides an abstract base class for
     ...
     to implement.
    */
    class ElementIntegralFunctionalFacet : public ElementIntegralFunctional
    {
    public:
      /** Constructor */
      ElementIntegralFunctionalFacet( int spatialDim,
	...
	ElementIntegralFunctional( spatialDim , maxCellType , 
				   dim , cellType , quad , verbParams ) {;}
      
      /** Destructor */
      virtual ~ElementIntegralFunctionalFacet() {;}
