...
#ifndef SUNDANCE_IQI_SCALVECBLF_UVJ_CELL_H
#define SUNDANCE_IQI_SCALVECBLF_UVJ_CELL_H
...
namespace SundanceStdFwk
{
  ...
  namespace Internal
  {
    ...
    */
    class IQI_ScalVecBLF_UVj_Cell : public ElementIntegralBilinearFormCell
    {
    public:
      /** Constructor */
      IQI_ScalVecBLF_UVj_Cell( int spatialDim,
      ...
      /** Destructor */
      virtual ~IQI_ScalVecBLF_UVj_Cell() {;}
