...
/*
 * SundancePeanoMeshType2D.hpp
 *
 *  Created on: Sep 16, 2009
 *      Author: benk
 */

#ifndef SUNDANCE_PEANOMESHTYPE2D_HPP_
#define SUNDANCE_PEANOMESHTYPE2D_HPP_
...
namespace Sundance
{
   ...
   * PeanoMesh objects.
   */
  class PeanoMeshType2D : public MeshTypeBase
  {
  public:
    /** Empty ctor */
	  PeanoMeshType2D(const MeshEntityOrder& order=ExodusMeshOrder)
	    : order_(order) {;}
    ...
    /** */
    std::string description() const {return "PeanoMeshType2D";}
...
#endif /* SUNDANCEPEANOMESHTYPE2D_HPP_ */
