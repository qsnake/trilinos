...
/** \file Target3DShapeSizeOrientAlt1.hpp
 *  \brief 
 *  \author Jason Kraftcheck 
 */

#ifndef MSQ_TARGET3D_SHAPE_SIZE_ORIENT_ALT1_HPP
#define MSQ_TARGET3D_SHAPE_SIZE_ORIENT_ALT1_HPP
...
/** |A-W|^2 */
class Target3DShapeSizeOrientAlt1 : public TargetMetric3D
{
  public:
